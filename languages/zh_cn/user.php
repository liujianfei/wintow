...
/* 发布 */
$_LANG['apply_time'] = '发布时间';
$_LANG['send_apply'] = '发布应用';

$_LANG['add_apply_success'] = '发布应用成功';
$_LANG['apply_list_lnk'] = '返回发布列表';
$_LANG['app_title_empty'] = '发布标题为空';

$_LANG['apply_empty'] = '您现在还没有发布应用！';
$_LANG['app_success'] = '您发布的产品已成功提交！';
$_LANG['confirm_remove_app'] = '你确实要取消发布您的产品吗？';
