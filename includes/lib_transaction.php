...
function get_profile($user_id)
{
    ...
    $sql  = "SELECT user_name, birthday, sex, question, answer, rank_points, pay_points,user_money, user_rank,".
             " msn, qq, office_phone, home_phone, mobile_phone, passwd_question, passwd_answer,user_type,real_name,company_name,card_type,country,province,city,district,address ".
	...
	$info['card_type'] = $infos['card_type'];
