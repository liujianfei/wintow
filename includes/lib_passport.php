...
function register($username, $password, $email, $other = array())
{
	...
	$sql = "UPDATE ".$GLOBALS['ecs']->table('users') ." SET company_name = '" . $company_name ."', user_type = '" . $user_type ."',real_name = '" . $real_name ."',card_type = '" . $card_type ."', country = '" . $country ."', office_phone = '" . $office_phone ."', province = '" . $province ."', city = '" . $city ."', district = '" . $district ."', address = '" . $address ."' WHERE user_id = " . $_SESSION['user_id'];
        ...
        //定义other合法的变量数组
        $other_key_array = array('msn', 'qq', 'home_phone', 'mobile_phone');
