...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $sql = "SELECT u.user_name,u.user_type,u.real_name,u.company_name,u.card_type,u.country,u.province,u.city,u.district,u.address, u.sex, u.birthday, u.pay_points, u.rank_points, u.user_rank , u.user_money, u.frozen_money, u.credit_line, u.parent_id, u2.user_name as parent_username, u.qq, u.msn, u.office_phone, u.home_phone, u.mobile_phone".
    ...
    $sql = "SELECT u.user_id,u.user_type,u.real_name,u.company_name,u.card_type,u.country,u.province,u.city,u.district,u.address, u.sex, u.birthday, u.pay_points, u.rank_points, u.user_rank , u.user_money, u.frozen_money, u.credit_line, u.parent_id, u2.user_name as parent_username, u.qq, u.msn,
    ...
    if ($row)
    {
		...
		//$user['contact_phone']  = $row['contact_phone'];
        $user['sex']            = $row['sex'];
...
if($user['user_type']==2)
  {
    ...
    $consignee_list[] = array('country' => $user['country'],'province' => $user['province'],'city' => $user['city'],'distric' => $user['distric'], 'email' => isset($_SESSION['email']) ? $_SESSION['email'] : '');
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    $db->autoExecute($ecs->table('users'), $other, 'UPDATE', "user_name = '$username'");
			...
			$office_phone = isset($_POST['office_phone']) ? intval($_POST['office_phone']) : '';
           ...
           if($_POST['user_types']==2)
           {
		    ...
		    $sql = "UPDATE ".$GLOBALS['ecs']->table('users') ." SET company_name = '" . $company_name ."', card_type = '" . $card_type ."', country = '" . $country ."', province = '" . $province ."', city = '" . $city ."', district = '" . $district ."', address = '" . $address ."' WHERE user_id = " . $user_id;
	//echo $sql;
...
elseif ($_REQUEST['act'] == 'remove')
{
    ...
    //$sql = "delete from " . $ecs->table('user_company') . " WHERE user_id = '" . $_GET['id'] . "'";
  //  $db->query($sql);
    /* 记录管理员操作 */
...
function user_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT user_id, user_name, user_type,email, is_validated, user_money, frozen_money, rank_points, pay_points, reg_time ".
