...
function userEdit()
{
 ...
 // var real_name = Utils.trim(frm.elements['real_name'].value);
...
function register()
{
 ...
 // var real_name = Utils.trim(frm.elements['real_name'].value);
 // var office_phone = Utils.trim(frm.elements['office_phone'].value);
  var CompanyName = Utils.trim(frm.elements['CompanyName'].value);
  ...
  var cardtype = Utils.trim(frm.elements['cardtype'].value);
 // var user_type =frm.elements['user_type'];
